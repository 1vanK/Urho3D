...
{
    members.methods_.Push(RegisterObjectMethodArgs("void HashBase::Swap(HashBase& rhs)", "void Swap(HashBase&)", AS_METHODPR(HashBase, Swap, (HashBase&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("unsigned HashBase::Size() const", "uint Size() const", AS_METHODPR(HashBase, Size, () const, unsigned), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("unsigned HashBase::NumBuckets() const", "uint NumBuckets() const", AS_METHODPR(HashBase, NumBuckets, () const, unsigned), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool HashBase::Empty() const", "bool Empty() const", AS_METHODPR(HashBase, Empty, () const, bool), AS_CALL_THISCALL));
...
void CollectMembers_RefCounted(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("int RefCounted::Refs() const", "int Refs() const", AS_METHODPR(RefCounted, Refs, () const, int), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("int RefCounted::Refs() const", "int get_refs() const", AS_METHODPR(RefCounted, Refs, () const, int), AS_CALL_THISCALL));
...
void CollectMembers_String(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("void String::Clear()", "void Clear()", AS_METHODPR(String, Clear, (), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void String::Swap(String& str)", "void Swap(String&)", AS_METHODPR(String, Swap, (String&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("char String::Front() const", "int8 Front() const", AS_METHODPR(String, Front, () const, char), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("char String::Back() const", "int8 Back() const", AS_METHODPR(String, Back, () const, char), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("String String::Substring(unsigned pos) const", "String Substring(uint) const", AS_METHODPR(String, Substring, (unsigned) const, String), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("String String::Substring(unsigned pos, unsigned length) const", "String Substring(uint, uint) const", AS_METHODPR(String, Substring, (unsigned, unsigned) const, String), AS_CALL_THISCALL));
    ...
    members.methods_.Push(RegisterObjectMethodArgs("unsigned String::NextUTF8Char(unsigned& byteOffset) const", "uint NextUTF8Char(uint&) const", AS_METHODPR(String, NextUTF8Char, (unsigned&) const, unsigned), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("unsigned String::AtUTF8(unsigned index) const", "uint AtUTF8(uint) const", AS_METHODPR(String, AtUTF8, (unsigned) const, unsigned), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void String::ReplaceUTF8(unsigned index, unsigned unicodeChar)", "void ReplaceUTF8(uint, uint)", AS_METHODPR(String, ReplaceUTF8, (unsigned, unsigned), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("String& String::AppendUTF8(unsigned unicodeChar)", "String& AppendUTF8(uint)", AS_METHODPR(String, AppendUTF8, (unsigned), String&), AS_CALL_THISCALL));
