...
void CollectMembers_Image(Vector<RegisterObjectMethodArgs>& methods, Vector<RegisterGlobalFunctionArgs>& staticMethods, Vector<RegisterObjectPropertyArgs>& fields, Vector<RegisterGlobalPropertyArgs>& staticFields)
{
    ...
    methods.Push(RegisterGlobalFunctionArgs("static void Image::RegisterObject(Context* context)", "void RegisterObject()", AS_FUNCTION(Image_RegisterObject_Context), AS_CALL_CDECL));
}
...
void CollectMembers_JSONFile(Vector<RegisterObjectMethodArgs>& methods, Vector<RegisterGlobalFunctionArgs>& staticMethods, Vector<RegisterObjectPropertyArgs>& fields, Vector<RegisterGlobalPropertyArgs>& staticFields)
{
    ...
    methods.Push(RegisterGlobalFunctionArgs("static void JSONFile::RegisterObject(Context* context)", "void RegisterObject()", AS_FUNCTION(JSONFile_RegisterObject_Context), AS_CALL_CDECL));
}
...
void CollectMembers_JSONValue(Vector<RegisterObjectMethodArgs>& methods, Vector<RegisterGlobalFunctionArgs>& staticMethods, Vector<RegisterObjectPropertyArgs>& fields, Vector<RegisterGlobalPropertyArgs>& staticFields)
{
    ...
    methods.Push(RegisterGlobalFunctionArgs("static String JSONValue::GetValueTypeName(JSONValueType type)", "String GetValueTypeName(JSONValueType)", AS_FUNCTIONPR(JSONValue::GetValueTypeName, (JSONValueType), String), AS_CALL_CDECL));
    methods.Push(RegisterGlobalFunctionArgs("static String JSONValue::GetNumberTypeName(JSONNumberType type)", "String GetNumberTypeName(JSONNumberType)", AS_FUNCTIONPR(JSONValue::GetNumberTypeName, (JSONNumberType), String), AS_CALL_CDECL));
    methods.Push(RegisterGlobalFunctionArgs("static JSONValueType JSONValue::GetValueTypeFromName(const String& typeName)", "JSONValueType GetValueTypeFromName(const String&in)", AS_FUNCTIONPR(JSONValue::GetValueTypeFromName, (const String&), JSONValueType), AS_CALL_CDECL));
    methods.Push(RegisterGlobalFunctionArgs("static JSONNumberType JSONValue::GetNumberTypeFromName(const String& typeName)", "JSONNumberType GetNumberTypeFromName(const String&in)", AS_FUNCTIONPR(JSONValue::GetNumberTypeFromName, (const String&), JSONNumberType), AS_CALL_CDECL));
...
void CollectMembers_XMLFile(Vector<RegisterObjectMethodArgs>& methods, Vector<RegisterGlobalFunctionArgs>& staticMethods, Vector<RegisterObjectPropertyArgs>& fields, Vector<RegisterGlobalPropertyArgs>& staticFields)
{
    ...
    methods.Push(RegisterGlobalFunctionArgs("static void XMLFile::RegisterObject(Context* context)", "void RegisterObject()", AS_FUNCTION(XMLFile_RegisterObject_Context), AS_CALL_CDECL));
}
