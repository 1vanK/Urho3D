...
void CollectMembers_AreaAllocator(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("bool AreaAllocator::GetFastMode() const", "bool GetFastMode() const", AS_METHODPR(AreaAllocator, GetFastMode, () const, bool), AS_CALL_THISCALL));
...
void CollectMembers_BoundingBox(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("void BoundingBox::Define(float min, float max)", "void Define(float, float)", AS_METHODPR(BoundingBox, Define, (float, float), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void BoundingBox::Define(const Vector3& point)", "void Define(const Vector3&in)", AS_METHODPR(BoundingBox, Define, (const Vector3&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void BoundingBox::Merge(const Vector3& point)", "void Merge(const Vector3&in)", AS_METHODPR(BoundingBox, Merge, (const Vector3&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void BoundingBox::Merge(const BoundingBox& box)", "void Merge(const BoundingBox&in)", AS_METHODPR(BoundingBox, Merge, (const BoundingBox&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void BoundingBox::Define(const Frustum& frustum)", "void Define(const Frustum&in)", AS_METHODPR(BoundingBox, Define, (const Frustum&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void BoundingBox::Define(const Polyhedron& poly)", "void Define(const Polyhedron&in)", AS_METHODPR(BoundingBox, Define, (const Polyhedron&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void BoundingBox::Define(const Sphere& sphere)", "void Define(const Sphere&in)", AS_METHODPR(BoundingBox, Define, (const Sphere&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void BoundingBox::Merge(const Frustum& frustum)", "void Merge(const Frustum&in)", AS_METHODPR(BoundingBox, Merge, (const Frustum&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void BoundingBox::Merge(const Polyhedron& poly)", "void Merge(const Polyhedron&in)", AS_METHODPR(BoundingBox, Merge, (const Polyhedron&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void BoundingBox::Merge(const Sphere& sphere)", "void Merge(const Sphere&in)", AS_METHODPR(BoundingBox, Merge, (const Sphere&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void BoundingBox::Clip(const BoundingBox& box)", "void Clip(const BoundingBox&in)", AS_METHODPR(BoundingBox, Clip, (const BoundingBox&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void BoundingBox::Transform(const Matrix3& transform)", "void Transform(const Matrix3&in)", AS_METHODPR(BoundingBox, Transform, (const Matrix3&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void BoundingBox::Transform(const Matrix3x4& transform)", "void Transform(const Matrix3x4&in)", AS_METHODPR(BoundingBox, Transform, (const Matrix3x4&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void BoundingBox::Clear()", "void Clear()", AS_METHODPR(BoundingBox, Clear, (), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool BoundingBox::Defined() const", "bool Defined() const", AS_METHODPR(BoundingBox, Defined, () const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 BoundingBox::Center() const", "Vector3 Center() const", AS_METHODPR(BoundingBox, Center, () const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 BoundingBox::Center() const", "Vector3 get_center() const", AS_METHODPR(BoundingBox, Center, () const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 BoundingBox::Size() const", "Vector3 Size() const", AS_METHODPR(BoundingBox, Size, () const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 BoundingBox::Size() const", "Vector3 get_size() const", AS_METHODPR(BoundingBox, Size, () const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 BoundingBox::HalfSize() const", "Vector3 HalfSize() const", AS_METHODPR(BoundingBox, HalfSize, () const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 BoundingBox::HalfSize() const", "Vector3 get_halfSize() const", AS_METHODPR(BoundingBox, HalfSize, () const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("BoundingBox BoundingBox::Transformed(const Matrix3& transform) const", "BoundingBox Transformed(const Matrix3&in) const", AS_METHODPR(BoundingBox, Transformed, (const Matrix3&) const, BoundingBox), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("BoundingBox BoundingBox::Transformed(const Matrix3x4& transform) const", "BoundingBox Transformed(const Matrix3x4&in) const", AS_METHODPR(BoundingBox, Transformed, (const Matrix3x4&) const, BoundingBox), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Rect BoundingBox::Projected(const Matrix4& projection) const", "Rect Projected(const Matrix4&in) const", AS_METHODPR(BoundingBox, Projected, (const Matrix4&) const, Rect), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float BoundingBox::DistanceToPoint(const Vector3& point) const", "float DistanceToPoint(const Vector3&in) const", AS_METHODPR(BoundingBox, DistanceToPoint, (const Vector3&) const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection BoundingBox::IsInside(const Vector3& point) const", "Intersection IsInside(const Vector3&in) const", AS_METHODPR(BoundingBox, IsInside, (const Vector3&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection BoundingBox::IsInside(const BoundingBox& box) const", "Intersection IsInside(const BoundingBox&in) const", AS_METHODPR(BoundingBox, IsInside, (const BoundingBox&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection BoundingBox::IsInsideFast(const BoundingBox& box) const", "Intersection IsInsideFast(const BoundingBox&in) const", AS_METHODPR(BoundingBox, IsInsideFast, (const BoundingBox&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection BoundingBox::IsInside(const Sphere& sphere) const", "Intersection IsInside(const Sphere&in) const", AS_METHODPR(BoundingBox, IsInside, (const Sphere&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection BoundingBox::IsInsideFast(const Sphere& sphere) const", "Intersection IsInsideFast(const Sphere&in) const", AS_METHODPR(BoundingBox, IsInsideFast, (const Sphere&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("String BoundingBox::ToString() const", "String ToString() const", AS_METHODPR(BoundingBox, ToString, () const, String), AS_CALL_THISCALL));
...
void CollectMembers_Color(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("Vector4 Color::ToVector4() const", "Vector4 get_rgba() const", AS_METHODPR(Color, ToVector4, () const, Vector4), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Color::SumRGB() const", "float SumRGB() const", AS_METHODPR(Color, SumRGB, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Color::Average() const", "float Average() const", AS_METHODPR(Color, Average, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Color::Luma() const", "float Luma() const", AS_METHODPR(Color, Luma, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Color::Chroma() const", "float Chroma() const", AS_METHODPR(Color, Chroma, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Color::Hue() const", "float Hue() const", AS_METHODPR(Color, Hue, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Color::SaturationHSL() const", "float SaturationHSL() const", AS_METHODPR(Color, SaturationHSL, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Color::SaturationHSV() const", "float SaturationHSV() const", AS_METHODPR(Color, SaturationHSV, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Color::Value() const", "float Value() const", AS_METHODPR(Color, Value, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Color Color::GammaToLinear() const", "Color GammaToLinear() const", AS_METHODPR(Color, GammaToLinear, () const, Color), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Color Color::LinearToGamma() const", "Color LinearToGamma() const", AS_METHODPR(Color, LinearToGamma, () const, Color), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Color::Lightness() const", "float Lightness() const", AS_METHODPR(Color, Lightness, () const, float), AS_CALL_THISCALL));
    ...
    members.methods_.Push(RegisterObjectMethodArgs("String Color::ToString() const", "String ToString() const", AS_METHODPR(Color, ToString, () const, String), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("unsigned Color::ToUIntArgb() const", "uint ToUIntArgb() const", AS_METHODPR(Color, ToUIntArgb, () const, unsigned), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("unsigned Color::ToHash() const", "uint ToHash() const", AS_METHODPR(Color, ToHash, () const, unsigned), AS_CALL_THISCALL));

    members.staticMethods_.Push(RegisterGlobalFunctionArgs("static float Color::ConvertGammaToLinear(float value)", "float ConvertGammaToLinear(float)", AS_FUNCTIONPR(Color::ConvertGammaToLinear, (float), float), AS_CALL_CDECL));
    members.staticMethods_.Push(RegisterGlobalFunctionArgs("static float Color::ConvertLinearToGamma(float value)", "float ConvertLinearToGamma(float)", AS_FUNCTIONPR(Color::ConvertLinearToGamma, (float), float), AS_CALL_CDECL));
...
void CollectMembers_Frustum(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("Intersection Frustum::IsInside(const Vector3& point) const", "Intersection IsInside(const Vector3&in) const", AS_METHODPR(Frustum, IsInside, (const Vector3&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection Frustum::IsInside(const Sphere& sphere) const", "Intersection IsInside(const Sphere&in) const", AS_METHODPR(Frustum, IsInside, (const Sphere&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection Frustum::IsInsideFast(const Sphere& sphere) const", "Intersection IsInsideFast(const Sphere&in) const", AS_METHODPR(Frustum, IsInsideFast, (const Sphere&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection Frustum::IsInside(const BoundingBox& box) const", "Intersection IsInside(const BoundingBox&in) const", AS_METHODPR(Frustum, IsInside, (const BoundingBox&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection Frustum::IsInsideFast(const BoundingBox& box) const", "Intersection IsInsideFast(const BoundingBox&in) const", AS_METHODPR(Frustum, IsInsideFast, (const BoundingBox&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Frustum::Distance(const Vector3& point) const", "float Distance(const Vector3&in) const", AS_METHODPR(Frustum, Distance, (const Vector3&) const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Frustum Frustum::Transformed(const Matrix3& transform) const", "Frustum Transformed(const Matrix3&in) const", AS_METHODPR(Frustum, Transformed, (const Matrix3&) const, Frustum), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Frustum Frustum::Transformed(const Matrix3x4& transform) const", "Frustum Transformed(const Matrix3x4&in) const", AS_METHODPR(Frustum, Transformed, (const Matrix3x4&) const, Frustum), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Rect Frustum::Projected(const Matrix4& projection) const", "Rect Projected(const Matrix4&in) const", AS_METHODPR(Frustum, Projected, (const Matrix4&) const, Rect), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Frustum::UpdatePlanes()", "void UpdatePlanes()", AS_METHODPR(Frustum, UpdatePlanes, (), void), AS_CALL_THISCALL));
...
void CollectMembers_IntRect(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("int IntRect::Width() const", "int get_width() const", AS_METHODPR(IntRect, Width, () const, int), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("int IntRect::Height() const", "int Height() const", AS_METHODPR(IntRect, Height, () const, int), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("int IntRect::Height() const", "int get_height() const", AS_METHODPR(IntRect, Height, () const, int), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection IntRect::IsInside(const IntVector2& point) const", "Intersection IsInside(const IntVector2&in) const", AS_METHODPR(IntRect, IsInside, (const IntVector2&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection IntRect::IsInside(const IntRect& rect) const", "Intersection IsInside(const IntRect&in) const", AS_METHODPR(IntRect, IsInside, (const IntRect&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void IntRect::Clip(const IntRect& rect)", "void Clip(const IntRect&in)", AS_METHODPR(IntRect, Clip, (const IntRect&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void IntRect::Merge(const IntRect& rect)", "void Merge(const IntRect&in)", AS_METHODPR(IntRect, Merge, (const IntRect&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("String IntRect::ToString() const", "String ToString() const", AS_METHODPR(IntRect, ToString, () const, String), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("IntVector2 IntRect::Min() const", "IntVector2 Min() const", AS_METHODPR(IntRect, Min, () const, IntVector2), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("IntVector2 IntRect::Max() const", "IntVector2 Max() const", AS_METHODPR(IntRect, Max, () const, IntVector2), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("int IntRect::Left() const", "int Left() const", AS_METHODPR(IntRect, Left, () const, int), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("int IntRect::Top() const", "int Top() const", AS_METHODPR(IntRect, Top, () const, int), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("int IntRect::Right() const", "int Right() const", AS_METHODPR(IntRect, Right, () const, int), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("int IntRect::Bottom() const", "int Bottom() const", AS_METHODPR(IntRect, Bottom, () const, int), AS_CALL_THISCALL));
...
void CollectMembers_Matrix2(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("Matrix2 Matrix2::Transpose() const", "Matrix2 Transpose() const", AS_METHODPR(Matrix2, Transpose, () const, Matrix2), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Matrix2 Matrix2::Scaled(const Vector2& scale) const", "Matrix2 Scaled(const Vector2&in) const", AS_METHODPR(Matrix2, Scaled, (const Vector2&) const, Matrix2), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Matrix2::Equals(const Matrix2& rhs) const", "bool Equals(const Matrix2&in) const", AS_METHODPR(Matrix2, Equals, (const Matrix2&) const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Matrix2 Matrix2::Inverse() const", "Matrix2 Inverse() const", AS_METHODPR(Matrix2, Inverse, () const, Matrix2), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Matrix2::IsNaN() const", "bool IsNaN() const", AS_METHODPR(Matrix2, IsNaN, () const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Matrix2::IsInf() const", "bool IsInf() const", AS_METHODPR(Matrix2, IsInf, () const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("String Matrix2::ToString() const", "String ToString() const", AS_METHODPR(Matrix2, ToString, () const, String), AS_CALL_THISCALL));
...
void CollectMembers_Matrix3(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Matrix3::SignedScale(const Matrix3& rotation) const", "Vector3 SignedScale(const Matrix3&in) const", AS_METHODPR(Matrix3, SignedScale, (const Matrix3&) const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Matrix3 Matrix3::Transpose() const", "Matrix3 Transpose() const", AS_METHODPR(Matrix3, Transpose, () const, Matrix3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Matrix3 Matrix3::Scaled(const Vector3& scale) const", "Matrix3 Scaled(const Vector3&in) const", AS_METHODPR(Matrix3, Scaled, (const Vector3&) const, Matrix3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Matrix3::Equals(const Matrix3& rhs) const", "bool Equals(const Matrix3&in) const", AS_METHODPR(Matrix3, Equals, (const Matrix3&) const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Matrix3 Matrix3::Inverse() const", "Matrix3 Inverse() const", AS_METHODPR(Matrix3, Inverse, () const, Matrix3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Matrix3::Element(unsigned i, unsigned j) const", "float Element(uint, uint) const", AS_METHODPR(Matrix3, Element, (unsigned, unsigned) const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Matrix3::Row(unsigned i) const", "Vector3 Row(uint) const", AS_METHODPR(Matrix3, Row, (unsigned) const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Matrix3::Column(unsigned j) const", "Vector3 Column(uint) const", AS_METHODPR(Matrix3, Column, (unsigned) const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Matrix3::IsNaN() const", "bool IsNaN() const", AS_METHODPR(Matrix3, IsNaN, () const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Matrix3::IsInf() const", "bool IsInf() const", AS_METHODPR(Matrix3, IsInf, () const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("String Matrix3::ToString() const", "String ToString() const", AS_METHODPR(Matrix3, ToString, () const, String), AS_CALL_THISCALL));
...
void CollectMembers_Matrix3x4(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("void Matrix3x4::SetScale(float scale)", "void SetScale(float)", AS_METHODPR(Matrix3x4, SetScale, (float), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Matrix3 Matrix3x4::ToMatrix3() const", "Matrix3 ToMatrix3() const", AS_METHODPR(Matrix3x4, ToMatrix3, () const, Matrix3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Matrix4 Matrix3x4::ToMatrix4() const", "Matrix4 ToMatrix4() const", AS_METHODPR(Matrix3x4, ToMatrix4, () const, Matrix4), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Matrix3 Matrix3x4::RotationMatrix() const", "Matrix3 RotationMatrix() const", AS_METHODPR(Matrix3x4, RotationMatrix, () const, Matrix3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Matrix3x4::Translation() const", "Vector3 Translation() const", AS_METHODPR(Matrix3x4, Translation, () const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Quaternion Matrix3x4::Rotation() const", "Quaternion Rotation() const", AS_METHODPR(Matrix3x4, Rotation, () const, Quaternion), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Matrix3x4::Scale() const", "Vector3 Scale() const", AS_METHODPR(Matrix3x4, Scale, () const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Matrix3x4::SignedScale(const Matrix3& rotation) const", "Vector3 SignedScale(const Matrix3&in) const", AS_METHODPR(Matrix3x4, SignedScale, (const Matrix3&) const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Matrix3x4::Equals(const Matrix3x4& rhs) const", "bool Equals(const Matrix3x4&in) const", AS_METHODPR(Matrix3x4, Equals, (const Matrix3x4&) const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Matrix3x4::Decompose(Vector3& translation, Quaternion& rotation, Vector3& scale) const", "void Decompose(Vector3&, Quaternion&, Vector3&) const", AS_METHODPR(Matrix3x4, Decompose, (Vector3&, Quaternion&, Vector3&) const, void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Matrix3x4 Matrix3x4::Inverse() const", "Matrix3x4 Inverse() const", AS_METHODPR(Matrix3x4, Inverse, () const, Matrix3x4), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Matrix3x4::Element(unsigned i, unsigned j) const", "float Element(uint, uint) const", AS_METHODPR(Matrix3x4, Element, (unsigned, unsigned) const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector4 Matrix3x4::Row(unsigned i) const", "Vector4 Row(uint) const", AS_METHODPR(Matrix3x4, Row, (unsigned) const, Vector4), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Matrix3x4::Column(unsigned j) const", "Vector3 Column(uint) const", AS_METHODPR(Matrix3x4, Column, (unsigned) const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Matrix3x4::IsNaN() const", "bool IsNaN() const", AS_METHODPR(Matrix3x4, IsNaN, () const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Matrix3x4::IsInf() const", "bool IsInf() const", AS_METHODPR(Matrix3x4, IsInf, () const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("String Matrix3x4::ToString() const", "String ToString() const", AS_METHODPR(Matrix3x4, ToString, () const, String), AS_CALL_THISCALL));
...
void CollectMembers_Matrix4(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("void Matrix4::SetScale(float scale)", "void SetScale(float)", AS_METHODPR(Matrix4, SetScale, (float), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Matrix3 Matrix4::ToMatrix3() const", "Matrix3 ToMatrix3() const", AS_METHODPR(Matrix4, ToMatrix3, () const, Matrix3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Matrix3 Matrix4::RotationMatrix() const", "Matrix3 RotationMatrix() const", AS_METHODPR(Matrix4, RotationMatrix, () const, Matrix3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Matrix4::Translation() const", "Vector3 Translation() const", AS_METHODPR(Matrix4, Translation, () const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Quaternion Matrix4::Rotation() const", "Quaternion Rotation() const", AS_METHODPR(Matrix4, Rotation, () const, Quaternion), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Matrix4::Scale() const", "Vector3 Scale() const", AS_METHODPR(Matrix4, Scale, () const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Matrix4::SignedScale(const Matrix3& rotation) const", "Vector3 SignedScale(const Matrix3&in) const", AS_METHODPR(Matrix4, SignedScale, (const Matrix3&) const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Matrix4 Matrix4::Transpose() const", "Matrix4 Transpose() const", AS_METHODPR(Matrix4, Transpose, () const, Matrix4), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Matrix4::Equals(const Matrix4& rhs) const", "bool Equals(const Matrix4&in) const", AS_METHODPR(Matrix4, Equals, (const Matrix4&) const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Matrix4::Decompose(Vector3& translation, Quaternion& rotation, Vector3& scale) const", "void Decompose(Vector3&, Quaternion&, Vector3&) const", AS_METHODPR(Matrix4, Decompose, (Vector3&, Quaternion&, Vector3&) const, void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Matrix4 Matrix4::Inverse() const", "Matrix4 Inverse() const", AS_METHODPR(Matrix4, Inverse, () const, Matrix4), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Matrix4::Element(unsigned i, unsigned j) const", "float Element(uint, uint) const", AS_METHODPR(Matrix4, Element, (unsigned, unsigned) const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector4 Matrix4::Row(unsigned i) const", "Vector4 Row(uint) const", AS_METHODPR(Matrix4, Row, (unsigned) const, Vector4), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector4 Matrix4::Column(unsigned j) const", "Vector4 Column(uint) const", AS_METHODPR(Matrix4, Column, (unsigned) const, Vector4), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Matrix4::IsNaN() const", "bool IsNaN() const", AS_METHODPR(Matrix4, IsNaN, () const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Matrix4::IsInf() const", "bool IsInf() const", AS_METHODPR(Matrix4, IsInf, () const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("String Matrix4::ToString() const", "String ToString() const", AS_METHODPR(Matrix4, ToString, () const, String), AS_CALL_THISCALL));
...
void CollectMembers_Plane(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("void Plane::Transform(const Matrix3& transform)", "void Transform(const Matrix3&in)", AS_METHODPR(Plane, Transform, (const Matrix3&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Plane::Transform(const Matrix3x4& transform)", "void Transform(const Matrix3x4&in)", AS_METHODPR(Plane, Transform, (const Matrix3x4&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Plane::Transform(const Matrix4& transform)", "void Transform(const Matrix4&in)", AS_METHODPR(Plane, Transform, (const Matrix4&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Plane::Project(const Vector3& point) const", "Vector3 Project(const Vector3&in) const", AS_METHODPR(Plane, Project, (const Vector3&) const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Plane::Distance(const Vector3& point) const", "float Distance(const Vector3&in) const", AS_METHODPR(Plane, Distance, (const Vector3&) const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Plane::Reflect(const Vector3& direction) const", "Vector3 Reflect(const Vector3&in) const", AS_METHODPR(Plane, Reflect, (const Vector3&) const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Matrix3x4 Plane::ReflectionMatrix() const", "Matrix3x4 ReflectionMatrix() const", AS_METHODPR(Plane, ReflectionMatrix, () const, Matrix3x4), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Matrix3x4 Plane::ReflectionMatrix() const", "Matrix3x4 get_reflectionMatrix() const", AS_METHODPR(Plane, ReflectionMatrix, () const, Matrix3x4), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Plane Plane::Transformed(const Matrix3& transform) const", "Plane Transformed(const Matrix3&in) const", AS_METHODPR(Plane, Transformed, (const Matrix3&) const, Plane), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Plane Plane::Transformed(const Matrix3x4& transform) const", "Plane Transformed(const Matrix3x4&in) const", AS_METHODPR(Plane, Transformed, (const Matrix3x4&) const, Plane), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Plane Plane::Transformed(const Matrix4& transform) const", "Plane Transformed(const Matrix4&in) const", AS_METHODPR(Plane, Transformed, (const Matrix4&) const, Plane), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector4 Plane::ToVector4() const", "Vector4 ToVector4() const", AS_METHODPR(Plane, ToVector4, () const, Vector4), AS_CALL_THISCALL));
...
void CollectMembers_Polyhedron(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("void Polyhedron::AddFace(const Vector3& v0, const Vector3& v1, const Vector3& v2, const Vector3& v3)", "void AddFace(const Vector3&in, const Vector3&in, const Vector3&in, const Vector3&in)", AS_METHODPR(Polyhedron, AddFace, (const Vector3&, const Vector3&, const Vector3&, const Vector3&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Polyhedron::AddFace(const PODVector<Vector3>& face)", "void AddFace(Array<Vector3>@+)", AS_FUNCTION_OBJFIRST(Polyhedron_AddFace_PODVectorVector3), AS_CALL_CDECL_OBJFIRST));
    members.methods_.Push(RegisterObjectMethodArgs("void Polyhedron::Clip(const Plane& plane)", "void Clip(const Plane&in)", AS_METHODPR(Polyhedron, Clip, (const Plane&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Polyhedron::Clip(const BoundingBox& box)", "void Clip(const BoundingBox&in)", AS_METHODPR(Polyhedron, Clip, (const BoundingBox&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Polyhedron::Clip(const Frustum& frustum)", "void Clip(const Frustum&in)", AS_METHODPR(Polyhedron, Clip, (const Frustum&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Polyhedron::Clear()", "void Clear()", AS_METHODPR(Polyhedron, Clear, (), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Polyhedron::Transform(const Matrix3& transform)", "void Transform(const Matrix3&in)", AS_METHODPR(Polyhedron, Transform, (const Matrix3&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Polyhedron::Transform(const Matrix3x4& transform)", "void Transform(const Matrix3x4&in)", AS_METHODPR(Polyhedron, Transform, (const Matrix3x4&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Polyhedron Polyhedron::Transformed(const Matrix3& transform) const", "Polyhedron Transformed(const Matrix3&in) const", AS_METHODPR(Polyhedron, Transformed, (const Matrix3&) const, Polyhedron), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Polyhedron Polyhedron::Transformed(const Matrix3x4& transform) const", "Polyhedron Transformed(const Matrix3x4&in) const", AS_METHODPR(Polyhedron, Transformed, (const Matrix3x4&) const, Polyhedron), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Polyhedron::Empty() const", "bool Empty() const", AS_METHODPR(Polyhedron, Empty, () const, bool), AS_CALL_THISCALL));
...
void CollectMembers_Quaternion(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("float Quaternion::LengthSquared() const", "float LengthSquared() const", AS_METHODPR(Quaternion, LengthSquared, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Quaternion::DotProduct(const Quaternion& rhs) const", "float DotProduct(const Quaternion&in) const", AS_METHODPR(Quaternion, DotProduct, (const Quaternion&) const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Quaternion::Equals(const Quaternion& rhs) const", "bool Equals(const Quaternion&in) const", AS_METHODPR(Quaternion, Equals, (const Quaternion&) const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Quaternion::IsNaN() const", "bool IsNaN() const", AS_METHODPR(Quaternion, IsNaN, () const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Quaternion::IsInf() const", "bool IsInf() const", AS_METHODPR(Quaternion, IsInf, () const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Quaternion Quaternion::Conjugate() const", "Quaternion Conjugate() const", AS_METHODPR(Quaternion, Conjugate, () const, Quaternion), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Quaternion::EulerAngles() const", "Vector3 EulerAngles() const", AS_METHODPR(Quaternion, EulerAngles, () const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Quaternion::EulerAngles() const", "Vector3 get_eulerAngles() const", AS_METHODPR(Quaternion, EulerAngles, () const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Quaternion::YawAngle() const", "float YawAngle() const", AS_METHODPR(Quaternion, YawAngle, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Quaternion::YawAngle() const", "float get_yaw() const", AS_METHODPR(Quaternion, YawAngle, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Quaternion::PitchAngle() const", "float PitchAngle() const", AS_METHODPR(Quaternion, PitchAngle, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Quaternion::PitchAngle() const", "float get_pitch() const", AS_METHODPR(Quaternion, PitchAngle, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Quaternion::RollAngle() const", "float RollAngle() const", AS_METHODPR(Quaternion, RollAngle, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Quaternion::RollAngle() const", "float get_roll() const", AS_METHODPR(Quaternion, RollAngle, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Quaternion::Axis() const", "Vector3 Axis() const", AS_METHODPR(Quaternion, Axis, () const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Quaternion::Axis() const", "Vector3 get_axis() const", AS_METHODPR(Quaternion, Axis, () const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Quaternion::Angle() const", "float Angle() const", AS_METHODPR(Quaternion, Angle, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Quaternion::Angle() const", "float get_angle() const", AS_METHODPR(Quaternion, Angle, () const, float), AS_CALL_THISCALL));
...
void CollectMembers_Rect(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("void Rect::Merge(const Vector2& point)", "void Merge(const Vector2&in)", AS_METHODPR(Rect, Merge, (const Vector2&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Rect::Merge(const Rect& rect)", "void Merge(const Rect&in)", AS_METHODPR(Rect, Merge, (const Rect&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Rect::Clear()", "void Clear()", AS_METHODPR(Rect, Clear, (), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Rect::Clip(const Rect& rect)", "void Clip(const Rect&in)", AS_METHODPR(Rect, Clip, (const Rect&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Rect::Defined() const", "bool Defined() const", AS_METHODPR(Rect, Defined, () const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector2 Rect::Center() const", "Vector2 Center() const", AS_METHODPR(Rect, Center, () const, Vector2), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector2 Rect::Center() const", "Vector2 get_center() const", AS_METHODPR(Rect, Center, () const, Vector2), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector2 Rect::Size() const", "Vector2 Size() const", AS_METHODPR(Rect, Size, () const, Vector2), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector2 Rect::Size() const", "Vector2 get_size() const", AS_METHODPR(Rect, Size, () const, Vector2), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector2 Rect::HalfSize() const", "Vector2 HalfSize() const", AS_METHODPR(Rect, HalfSize, () const, Vector2), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector2 Rect::HalfSize() const", "Vector2 get_halfSize() const", AS_METHODPR(Rect, HalfSize, () const, Vector2), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Rect::Equals(const Rect& rhs) const", "bool Equals(const Rect&in) const", AS_METHODPR(Rect, Equals, (const Rect&) const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection Rect::IsInside(const Vector2& point) const", "Intersection IsInside(const Vector2&in) const", AS_METHODPR(Rect, IsInside, (const Vector2&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection Rect::IsInside(const Rect& rect) const", "Intersection IsInside(const Rect&in) const", AS_METHODPR(Rect, IsInside, (const Rect&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector4 Rect::ToVector4() const", "Vector4 ToVector4() const", AS_METHODPR(Rect, ToVector4, () const, Vector4), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("String Rect::ToString() const", "String ToString() const", AS_METHODPR(Rect, ToString, () const, String), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector2 Rect::Min() const", "Vector2 Min() const", AS_METHODPR(Rect, Min, () const, Vector2), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector2 Rect::Max() const", "Vector2 Max() const", AS_METHODPR(Rect, Max, () const, Vector2), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Rect::Left() const", "float Left() const", AS_METHODPR(Rect, Left, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Rect::Left() const", "float get_left() const", AS_METHODPR(Rect, Left, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Rect::Top() const", "float Top() const", AS_METHODPR(Rect, Top, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Rect::Top() const", "float get_top() const", AS_METHODPR(Rect, Top, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Rect::Right() const", "float Right() const", AS_METHODPR(Rect, Right, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Rect::Right() const", "float get_right() const", AS_METHODPR(Rect, Right, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Rect::Bottom() const", "float Bottom() const", AS_METHODPR(Rect, Bottom, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Rect::Bottom() const", "float get_bottom() const", AS_METHODPR(Rect, Bottom, () const, float), AS_CALL_THISCALL));
...
void CollectMembers_Sphere(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("void Sphere::Define(const Frustum& frustum)", "void Define(const Frustum&in)", AS_METHODPR(Sphere, Define, (const Frustum&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Sphere::Define(const Polyhedron& poly)", "void Define(const Polyhedron&in)", AS_METHODPR(Sphere, Define, (const Polyhedron&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Sphere::Merge(const Vector3& point)", "void Merge(const Vector3&in)", AS_METHODPR(Sphere, Merge, (const Vector3&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Sphere::Merge(const BoundingBox& box)", "void Merge(const BoundingBox&in)", AS_METHODPR(Sphere, Merge, (const BoundingBox&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Sphere::Merge(const Frustum& frustum)", "void Merge(const Frustum&in)", AS_METHODPR(Sphere, Merge, (const Frustum&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Sphere::Merge(const Polyhedron& poly)", "void Merge(const Polyhedron&in)", AS_METHODPR(Sphere, Merge, (const Polyhedron&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Sphere::Merge(const Sphere& sphere)", "void Merge(const Sphere&in)", AS_METHODPR(Sphere, Merge, (const Sphere&), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("void Sphere::Clear()", "void Clear()", AS_METHODPR(Sphere, Clear, (), void), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Sphere::Defined() const", "bool Defined() const", AS_METHODPR(Sphere, Defined, () const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection Sphere::IsInside(const Vector3& point) const", "Intersection IsInside(const Vector3&in) const", AS_METHODPR(Sphere, IsInside, (const Vector3&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection Sphere::IsInside(const Sphere& sphere) const", "Intersection IsInside(const Sphere&in) const", AS_METHODPR(Sphere, IsInside, (const Sphere&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection Sphere::IsInsideFast(const Sphere& sphere) const", "Intersection IsInsideFast(const Sphere&in) const", AS_METHODPR(Sphere, IsInsideFast, (const Sphere&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection Sphere::IsInside(const BoundingBox& box) const", "Intersection IsInside(const BoundingBox&in) const", AS_METHODPR(Sphere, IsInside, (const BoundingBox&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Intersection Sphere::IsInsideFast(const BoundingBox& box) const", "Intersection IsInsideFast(const BoundingBox&in) const", AS_METHODPR(Sphere, IsInsideFast, (const BoundingBox&) const, Intersection), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Sphere::Distance(const Vector3& point) const", "float Distance(const Vector3&in) const", AS_METHODPR(Sphere, Distance, (const Vector3&) const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Sphere::GetLocalPoint(float theta, float phi) const", "Vector3 GetLocalPoint(float, float) const", AS_METHODPR(Sphere, GetLocalPoint, (float, float) const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Sphere::GetPoint(float theta, float phi) const", "Vector3 GetPoint(float, float) const", AS_METHODPR(Sphere, GetPoint, (float, float) const, Vector3), AS_CALL_THISCALL));
...
void CollectMembers_Vector2(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("float Vector2::LengthSquared() const", "float LengthSquared() const", AS_METHODPR(Vector2, LengthSquared, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Vector2::LengthSquared() const", "float get_lengthSquared() const", AS_METHODPR(Vector2, LengthSquared, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Vector2::DotProduct(const Vector2& rhs) const", "float DotProduct(const Vector2&in) const", AS_METHODPR(Vector2, DotProduct, (const Vector2&) const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Vector2::AbsDotProduct(const Vector2& rhs) const", "float AbsDotProduct(const Vector2&in) const", AS_METHODPR(Vector2, AbsDotProduct, (const Vector2&) const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Vector2::ProjectOntoAxis(const Vector2& axis) const", "float ProjectOntoAxis(const Vector2&in) const", AS_METHODPR(Vector2, ProjectOntoAxis, (const Vector2&) const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Vector2::Angle(const Vector2& rhs) const", "float Angle(const Vector2&in) const", AS_METHODPR(Vector2, Angle, (const Vector2&) const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector2 Vector2::Abs() const", "Vector2 Abs() const", AS_METHODPR(Vector2, Abs, () const, Vector2), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector2 Vector2::Lerp(const Vector2& rhs, float t) const", "Vector2 Lerp(const Vector2&in, float) const", AS_METHODPR(Vector2, Lerp, (const Vector2&, float) const, Vector2), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Vector2::Equals(const Vector2& rhs) const", "bool Equals(const Vector2&in) const", AS_METHODPR(Vector2, Equals, (const Vector2&) const, bool), AS_CALL_THISCALL));
...
void CollectMembers_Vector3(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("float Vector3::LengthSquared() const", "float LengthSquared() const", AS_METHODPR(Vector3, LengthSquared, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Vector3::LengthSquared() const", "float get_lengthSquared() const", AS_METHODPR(Vector3, LengthSquared, () const, float), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Vector3::DotProduct(const Vector3& rhs) const", "float DotProduct(const Vector3&in) const", AS_METHODPR(Vector3, DotProduct, (const Vector3&) const, float), AS_CALL_THISCALL));
    ...
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Vector3::CrossProduct(const Vector3& rhs) const", "Vector3 CrossProduct(const Vector3&in) const", AS_METHODPR(Vector3, CrossProduct, (const Vector3&) const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Vector3::Abs() const", "Vector3 Abs() const", AS_METHODPR(Vector3, Abs, () const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector3 Vector3::Lerp(const Vector3& rhs, float t) const", "Vector3 Lerp(const Vector3&in, float) const", AS_METHODPR(Vector3, Lerp, (const Vector3&, float) const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Vector3::Equals(const Vector3& rhs) const", "bool Equals(const Vector3&in) const", AS_METHODPR(Vector3, Equals, (const Vector3&) const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("float Vector3::Angle(const Vector3& rhs) const", "float Angle(const Vector3&in) const", AS_METHODPR(Vector3, Angle, (const Vector3&) const, float), AS_CALL_THISCALL));
...
void CollectMembers_Vector4(MemberCollection& members)
{
    ...
    members.methods_.Push(RegisterObjectMethodArgs("Vector4 Vector4::Abs() const", "Vector4 Abs() const", AS_METHODPR(Vector4, Abs, () const, Vector4), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("Vector4 Vector4::Lerp(const Vector4& rhs, float t) const", "Vector4 Lerp(const Vector4&in, float) const", AS_METHODPR(Vector4, Lerp, (const Vector4&, float) const, Vector4), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Vector4::Equals(const Vector4& rhs) const", "bool Equals(const Vector4&in) const", AS_METHODPR(Vector4, Equals, (const Vector4&) const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Vector4::IsNaN() const", "bool IsNaN() const", AS_METHODPR(Vector4, IsNaN, () const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("bool Vector4::IsInf() const", "bool IsInf() const", AS_METHODPR(Vector4, IsInf, () const, bool), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("explicit Vector4::operator Vector2() const", "Vector2 opConv() const", AS_METHODPR(Vector4, operator Vector2, () const, Vector2), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("explicit Vector4::operator Vector3() const", "Vector3 opConv() const", AS_METHODPR(Vector4, operator Vector3, () const, Vector3), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("String Vector4::ToString() const", "String ToString() const", AS_METHODPR(Vector4, ToString, () const, String), AS_CALL_THISCALL));
    members.methods_.Push(RegisterObjectMethodArgs("unsigned Vector4::ToHash() const", "uint ToHash() const", AS_METHODPR(Vector4, ToHash, () const, unsigned), AS_CALL_THISCALL));
