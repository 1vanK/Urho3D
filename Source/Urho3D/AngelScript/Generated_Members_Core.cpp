...
void CollectMembers_EventProfiler(Vector<RegisterObjectMethodArgs>& methods, Vector<RegisterGlobalFunctionArgs>& staticMethods, Vector<RegisterObjectPropertyArgs>& fields, Vector<RegisterGlobalPropertyArgs>& staticFields)
{
    ...
    methods.Push(RegisterGlobalFunctionArgs("static void EventProfiler::SetActive(bool newActive)", "void SetActive(bool)", AS_FUNCTIONPR(EventProfiler::SetActive, (bool), void), AS_CALL_CDECL));
    methods.Push(RegisterGlobalFunctionArgs("static bool EventProfiler::IsActive()", "bool IsActive()", AS_FUNCTIONPR(EventProfiler::IsActive, (), bool), AS_CALL_CDECL));
}
...
void CollectMembers_HiresTimer(Vector<RegisterObjectMethodArgs>& methods, Vector<RegisterGlobalFunctionArgs>& staticMethods, Vector<RegisterObjectPropertyArgs>& fields, Vector<RegisterGlobalPropertyArgs>& staticFields)
{
    ...
    methods.Push(RegisterGlobalFunctionArgs("static bool HiresTimer::IsSupported()", "bool IsSupported()", AS_FUNCTIONPR(HiresTimer::IsSupported, (), bool), AS_CALL_CDECL));
    methods.Push(RegisterGlobalFunctionArgs("static long long HiresTimer::GetFrequency()", "int64 GetFrequency()", AS_FUNCTIONPR(HiresTimer::GetFrequency, (), long long), AS_CALL_CDECL));
}
...
void CollectMembers_Thread(Vector<RegisterObjectMethodArgs>& methods, Vector<RegisterGlobalFunctionArgs>& staticMethods, Vector<RegisterObjectPropertyArgs>& fields, Vector<RegisterGlobalPropertyArgs>& staticFields)
{
    ...
    methods.Push(RegisterGlobalFunctionArgs("static void Thread::SetMainThread()", "void SetMainThread()", AS_FUNCTIONPR(Thread::SetMainThread, (), void), AS_CALL_CDECL));
    methods.Push(RegisterGlobalFunctionArgs("static bool Thread::IsMainThread()", "bool IsMainThread()", AS_FUNCTIONPR(Thread::IsMainThread, (), bool), AS_CALL_CDECL));
}
...
void CollectMembers_Time(Vector<RegisterObjectMethodArgs>& methods, Vector<RegisterGlobalFunctionArgs>& staticMethods, Vector<RegisterObjectPropertyArgs>& fields, Vector<RegisterGlobalPropertyArgs>& staticFields)
{
    ...
    methods.Push(RegisterGlobalFunctionArgs("static unsigned Time::GetSystemTime()", "uint GetSystemTime()", AS_FUNCTIONPR(Time::GetSystemTime, (), unsigned), AS_CALL_CDECL));
    methods.Push(RegisterGlobalFunctionArgs("static unsigned Time::GetTimeSinceEpoch()", "uint GetTimeSinceEpoch()", AS_FUNCTIONPR(Time::GetTimeSinceEpoch, (), unsigned), AS_CALL_CDECL));
    methods.Push(RegisterGlobalFunctionArgs("static String Time::GetTimeStamp()", "String GetTimeStamp()", AS_FUNCTIONPR(Time::GetTimeStamp, (), String), AS_CALL_CDECL));
    methods.Push(RegisterGlobalFunctionArgs("static void Time::Sleep(unsigned mSec)", "void Sleep(uint)", AS_FUNCTIONPR(Time::Sleep, (unsigned), void), AS_CALL_CDECL));
}
...
void CollectMembers_Variant(Vector<RegisterObjectMethodArgs>& methods, Vector<RegisterGlobalFunctionArgs>& staticMethods, Vector<RegisterObjectPropertyArgs>& fields, Vector<RegisterGlobalPropertyArgs>& staticFields)
{
    ...
    methods.Push(RegisterGlobalFunctionArgs("static String Variant::GetTypeName(VariantType type)", "String GetTypeName(VariantType)", AS_FUNCTIONPR(Variant::GetTypeName, (VariantType), String), AS_CALL_CDECL));
    methods.Push(RegisterGlobalFunctionArgs("static VariantType Variant::GetTypeFromName(const String& typeName)", "VariantType GetTypeFromName(const String&in)", AS_FUNCTIONPR(Variant::GetTypeFromName, (const String&), VariantType), AS_CALL_CDECL));
